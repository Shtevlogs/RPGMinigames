...
func _init(p_character: CharacterBattleEntity = null, p_target: BattleEntity = null, p_target_strategy: int = 0, p_enemy_cards: Array = [], p_enemy_id: String = "", p_redos_available: int = 0):
