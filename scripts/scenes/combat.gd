...
func _on_ability_pressed() -> void:
    ...
    if needs_target:
        ...
        open_minigame_modal(null, current_combatant)
...
func _advance_to_next_land() -> void:
    ...
    if GameManager.current_run.land_sequence.size() >= GameManager.current_run.current_land:
        ...
        GameManager.current_run.current_land_theme = "random" #this is maybe the dumbest AI thing I've ever seen
...
func open_minigame_modal(target: BattleEntity, character: CharacterBattleEntity) -> void:
